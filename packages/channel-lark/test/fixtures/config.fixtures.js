...
export const validChannelConfig = {
...
export const missingAppSecretConfig = {
    token: 'cli_test_app_id',
    options: {},
};
/** appSecret 为空字符串的无效配置（应该抛错） */
export const emptyAppSecretConfig = {
    token: 'cli_test_app_id',
    options: {
        appSecret: '',
    },
...
export const missingTokenConfig = {
    token: '',
    options: {
        appSecret: 'test_app_secret_12345',
    },
...
//# sourceMappingURL=config.fixtures.js.map